...
const basePath = '/core-tech-1776411245561';
...
export default function Home() {
  ...
  const products = [{ n: 'Product 1', d: 'Reliable and secure web hosting solutions, ensuring maximum uptime and performance for your online presence.', icon: 'domain' }, { n: 'Product 2', d: 'Custom web development services, crafting engaging and user-friendly websites that reflect your brand and vision.', icon: 'architecture' }, { n: 'Product 3', d: 'Expert mobile and desktop application development, designing intuitive and feature-rich apps that drive business results.', icon: 'chair' }, { n: 'Product 4', d: 'Easy and efficient domain registration and management, providing a seamless online experience for your business.', icon: 'eco' }, { n: 'Product 5', d: 'Dedicated support and inquiry services, offering prompt and personalized assistance to address your technology needs.', icon: 'precision_manufacturing' }];
    ...
    <div className="min-h-screen bg-surface text-on-surface font-body">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-xl shadow-sm">
        <div className="flex justify-between items-center px-8 py-4 max-w-7xl mx-auto">
          <span className="text-2xl font-black text-primary font-headline">Core Tech</span>
      ...
      <section id="home" className="relative h-screen flex items-center justify-center bg-primary">
        <div className="text-center text-white px-8">
          ...
          <h1 className="font-headline text-5xl md:text-7xl font-extrabold mt-4 mb-6">Core Tech</h1>
          <p className="text-xl text-white/80 max-w-2xl mx-auto mb-10">Best Tech Solution Kuching</p>
      ...
      <section id="about" className="py-24 bg-surface">
        <div className="max-w-7xl mx-auto px-8">
          ...
          <h2 className="font-headline text-4xl font-extrabold mt-2 mb-8">Core Tech</h2>
          <p className="text-on-surface-variant text-lg max-w-3xl mb-12">Core Tech is a leading technology solutions provider based in Kuching, dedicated to delivering innovative and effective services to our clients.</p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div><h4 className="font-bold text-primary">Vision</h4><p className="text-sm text-on-surface-variant">To be the premier technology partner in the region, empowering businesses to succeed in the digital age.</p></div>
            <div><h4 className="font-bold text-primary">Mission</h4><p className="text-sm text-on-surface-variant">To provide exceptional technology solutions that exceed our clients\' expectations, fostering long-term relationships and driving growth.</p></div>
            <div><h4 className="font-bold text-primary">Customer first</h4><p className="text-sm text-on-surface-variant">Customer-centric approach: We prioritize our clients\' needs, delivering tailored solutions that meet their unique requirements.</p></div>
            <div><h4 className="font-bold text-primary">Innovation</h4><p className="text-sm text-on-surface-variant">Innovation and excellence: We strive to stay at the forefront of technology, continuously improving our services and expertise to drive success.</p></div>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-primary py-12 px-8">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="text-white font-bold">Core Tech</div>
          ...
          <p className="text-white/60 text-sm">&copy; {new Date().getFullYear()} Core Tech</p>
        </div>
      </footer>
    </div>
  );
